...
export function normalizeEvent(event, league, tzMode = 'denver', devigMethod = 'multiplicative') {
  ...
  // Where the game is in its life: 'pre' not started, 'in' underway, 'post'
  // over. ESPN reports both a coarse state and a completed flag; a postponed or
  // cancelled game reaches 'post' without ever being completed, and neither is
  // something a forward-looking board should list.
