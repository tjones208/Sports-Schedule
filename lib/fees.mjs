...
export function kellyNet(p, priceCents, fraction = 0.25, role = 'taker') {
  ...
  // The fee is paid up front either way, so it comes out of the winning payout
  // as well as the outlay. Defining both sides this way makes Kelly's breakeven
  // identical to the fee-inclusive price, which is what netEdge reports.
